// Types For RidePopUp Components
type RidePopUpProps = {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between">
        <h3 className="text-3xl font-bold my-4">New Ride Available!</h3>
      ...
      <div className="flex flex-col items-center justify-center w-full gap-4">
        ...
        {/* Ignore button */}
        <button
          className="w-full bg-gray-300 text-gray-700 font-semibold p-2 rounded-lg text-xl"
          onClick={() => {
            setRidePopupPanel(false);
          }}
        >
